...
INSERT INTO `admin` (`id`, `username`, `nickname`, `salt`, `age`, `avatar`, `loginfailure`, `logintime`, `loginip`, `token`, `password`, `created`, `updated`, `phone`, `email`) VALUES
(1, 'admin', '', 'MRq2', NULL, 'favicon.ico', NULL, NULL, NULL, NULL, '052931db8810edf6dc84d8c9a908e0d6', NULL, '2022-12-20 14:09:49', '189076938272', '707229207@qq.com'),
(32, 'ces124454', 'ces1', 'V9rU', 0, 'http://file.988cj.com/group1/default/20221216/17/18/3/微信图片_20221206104202.jpg', 0, 0, '', '', 'e625857c3e3dcb62bdf89ea857085a39', '2022-12-16 17:18:19', '2022-12-19 09:49:23', '11', '11'),
(33, 'ces2', '测试2', 'OO6T', 0, 'http://file.988cj.com/group1/default/20221216/15/45/3/20201030114158.png', 0, 0, '', '', '8466e5e44de8f8bb4f8a06fac522973a', '2022-12-16 17:24:45', '2022-12-19 10:39:48', '18907693872', '18907693872@qq.com'),
(34, 'ces3', 'ces3', 'gtg0', 0, 'http://file.988cj.com/group1/default/20221216/15/33/3/5759802236d4ec0d1349b95554525e91.jpg', 0, 0, '', '', '0a123ab2c718e1888b5bccc7d0c2714e', '2022-12-16 17:37:19', '2022-12-16 17:37:19', '12223', '12123'),
(35, 'wangran', '111', 'sryP', 0, 'http://file.988cj.com/group1/default/20221216/17/17/3/微信图片_20221117152257.jpg', 0, 0, '', '', 'a41ff83f1eaf0e624eb0580ee6170a55', '2022-12-19 10:32:32', '2022-12-19 10:32:32', '1212333423', '23232323');
...
INSERT INTO `area` (`id`, `pid`, `shortname`, `name`, `mergename`, `level`, `pinyin`, `code`, `zip`, `first`, `lng`, `lat`) VALUES
...
INSERT INTO `auth_group` (`id`, `pid`, `name`, `rules`, `createtime`, `updatetime`, `status`, `created`, `updated`) VALUES
(1, 0, 'Admin group', '*', 1490883540, 149088354, '1', NULL, NULL),
(12, 1, '管理组', '1,2,3,4,5,347,6,351,352,0', NULL, NULL, '0', 1671438417, NULL),
(13, 12, '管理二组', '1,2,3,361,0', NULL, NULL, '0', 1671438458, NULL);
...
INSERT INTO `auth_group_access` (`uid`, `gid`) VALUES
(1, 1),
(32, 1),
(33, 10),
(34, 1),
...
(2, 1, 'file', 'el-icon-notebook-2', '/system/admin', '管理员列表', '用户列表', 0, 1614759419, 1673339018, NULL, 1, 'normal', 'system/admin/index'),
(3, 1, 'file', 'el-icon-notebook-2', '/system/rules', '菜单管理', '前端菜单', 0, 1614759461, 1662431244, NULL, 2, 'normal', 'system/rules/index'),
(360, 357, '', 'el-icon-open', '/all/device', '设备信息', '', 0, 1673248650, 1673592134, 0, 0, '', 'device/index'),
(1, 0, 'file', 'el-icon-menu', '/system', '系统管理', '用户管理', 1, 1621413412, NULL, NULL, 0, 'normal', NULL),
(5, 0, 'file', 'el-icon-setting', '/share', '公共配置', '公共配置', 1, 1619409666, 1662445753, NULL, 0, 'normal', NULL),
(358, 5, '', 'el-icon-s-flag', '/share/city', '城市管理', '', 0, 1671527625, 1671527625, 0, 0, '', 'share/city'),
(362, 5, '', 'el-icon-setting', 'sdafaf ', 'ces1333', '', 0, 1673837239, 1673837309, 0, 0, '', 'dadfad'),
(357, 0, 'file', 'el-icon-coin', '/all', '设备管理', '', 1, 1671525883, 1673575520, 0, 0, '', ''),
(359, 357, '', 'el-icon-s-fold', '/law/category', '分类管理', '', 0, 1671528375, 1671528375, 0, 0, '', 'law/category'),
(361, 1, '', 'el-icon-user', '/system/group', '组别管理', '', 0, 1673574878, 1673574936, 0, 0, '', 'system/group/index');
...
INSERT INTO `category` (`id`, `pid`, `title`, `image`, `keywords`, `description`, `content`, `isshow`, `created`, `updated`, `weigh`, `status`) VALUES
(1, 0, '电压设备', 'http://file.988cj.com/group1/default/20221216/15/45/3/20201030114158.png', '软件分类1333', '软件分类1', '软件分类1', 1, 22333, NULL, NULL, NULL),
(2, 0, '温度设备1', 'http://file.988cj.com/group1/default/20221216/16/37/3/12345平台意见反馈流程 （意见征集）.png', '大二地方55555', '', '达成3', 0, 1672739513, NULL, 0, 0),
(3, 0, 'HC4设备', 'http://file.988cj.com/group1/default/20221216/15/33/3/5759802236d4ec0d1349b95554525e91.jpg', '测试关键字3333', '', '大擦擦阿斯顿擦', 0, 1672739848, NULL, 0, 0),
(5, 0, '其他设备', '', '办公软件', '', '办公软件', 0, 1672905366, NULL, 0, 0);
...
CREATE TABLE `device` (
  `id` bigint(20) NOT NULL,
  `categroyid` bigint(20) DEFAULT NULL,
  ...
  `isopen` tinyint(4) NOT NULL DEFAULT '1' COMMENT '是否启用 默认1 菜单 0 文件',
  `created` int(11) DEFAULT NULL,
  `updated` int(11) DEFAULT NULL,
  `deletetime` int(11) DEFAULT NULL,
  `weigh` int(11) DEFAULT NULL,
  `status` tinyint(4) NOT NULL DEFAULT '1' COMMENT '是否启用 默认1 未激活 2 已激活 3 未在线 4 在线'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
INSERT INTO `device` (`id`, `categroyid`, `simid`, `number`, `name`, `image`, `remark`, `factory`, `contactpeople`, `phone`, `isopen`, `created`, `updated`, `deletetime`, `weigh`, `status`) VALUES
(1, 0, 0, 'LS001', '电压设备1', '', '电压设备1', '海南雷龙王设备有限公司', '李总', '18907869382', 0, 1673839029, 1673839029, 0, 0, 0),
(2, 0, 0, '打法', '测试', 'http://file.988cj.com/group1/default/20230116/11/28/3/37d3d539b6003af39778425f312ac65c1138b6cb.jpg', '23232323', '大ad', '啊阿达aa', ' 13', 0, 1673839733, 1673839733, 0, 0, 0);
...
INSERT INTO `news` (`id`, `categoryid`, `title`, `image`, `keywords`, `description`, `content`, `isshow`, `created`, `updated`, `weigh`, `status`) VALUES
(1, 0, '办公信息第一标题OA软件', 'http://file.988cj.com/group1/default/20221216/15/45/3/20201030114158.png', '测啊', '', '大啊多发点', 0, 1673252390, NULL, 0, 0),
(2, 0, '撒答复', '', '啊打发啊d', '', 'd阿发啊地方', 0, 1673252437, NULL, 0, 0),
(3, 0, '擦都擦', '', '2323', '', '23323223', 0, 1673252584, NULL, 0, 0),
(4, 0, '2大地方阿发答复', '', '答复ad', '', '发达安抚', 0, 1673252669, NULL, 0, 0),
(5, 0, '成为下达安措费 ', '', '达成aac', '', '啊大擦', 1, 1673252842, NULL, 0, 0),
(6, 0, '办公1', '', '32323', '', '232323', 1, 1673339795, NULL, 0, 0);
...
CREATE TABLE `simcard` (
  ...
  `remark` varchar(255) DEFAULT NULL,
  `isopen` tinyint(4) NOT NULL DEFAULT '1' COMMENT '是否启用 默认1 菜单 0 文件',
  `isbind` tinyint(4) NOT NULL DEFAULT '1' COMMENT '是否启用 默认1 菜单 0 文件',
  `weigh` int(11) DEFAULT NULL,
  `status` tinyint(4) NOT NULL DEFAULT '1' COMMENT '是否启用 默认1 未在线 2 在线 3 异常',
  `created` int(11) DEFAULT NULL,
  `updated` int(11) DEFAULT NULL,
  `deletetime` int(11) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
ALTER TABLE `area`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3749;
